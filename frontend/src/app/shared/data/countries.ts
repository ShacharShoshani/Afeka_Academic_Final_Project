// Lightweight country data: ISO 3166-1 alpha-2 code + English name.
// Flag emoji is derived from the code (regional-indicator letters) so there is no
// flag-image bundle and no extra dependency.

export interface Country {
  code: string; // ISO alpha-2, e.g. "IL"
  name: string;
}

/** Convert an ISO alpha-2 code into its emoji flag (e.g. "IL" → 🇮🇱). */
